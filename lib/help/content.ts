...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    summary: "Best-set and total-load change against the same exercise last session. Saved data only, no AI.",
  ...
  },
  {
    ...
    summary: "Sprints, jumps and throws with their own card layout and a summary bar.",
    keywords: ["power", "speed", "sprint", "jump", "throw", "plyometric"],
    body: [
      { type: "p", text: "**+ Add session** → **Power/Speed** gives each exercise a Power/Speed card and shows a summary bar for the session. Use it for timed sprints, jump heights/distances and throw distances." },
      { type: "p", text: "Results feed the athlete's **⚡ Power / Speed** page and the Power/Speed sections of reports. The red/amber/green ratings there come from Settings → Power/Speed Benchmarks." },
    ],
  },
  {
  ...
  },
  {
    ...
    summary: "A Sunday prompt in the athlete app with score metrics and three written prompts.",
    keywords: ["weekly reflection", "reflection", "sunday", "review", "journaling"],
    body: [
      ...
      { type: "note", text: "The prompt only appears in the athlete app on Sundays, showing the week commencing date." },
    ],
  },
  {
  ...
  // ═══════════════════════ Your athletes' app ═══════════════════════
  {
    ...
    body: [
      ...
      { type: "steps", items: [
        ...
        "On Sundays, a **📝 Weekly Reflection** prompt (if you've enabled reflections).",
      ] },
    ],
  },
  {
  ...
  },
  {
    ...
    summary: "Goals you set plus goals they add; priority stars and live progress.",
    keywords: ["goals", "targets", "athlete goals"],
    body: [
      { type: "p", text: "Under **🎯 Goals** the athlete sees goals you've set for them alongside any they add themselves (**+ Add your own goal**). Exercise goals show live progress — current best vs target, with a bar and a **✓ Achieved** badge at 100%. The **⭐** star marks a goal as a priority." },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      { type: "p", text: "The signal compares against the most recent session that contains an exercise with the **same name**. If the athlete has never done that exact exercise before — or the name is spelled differently — there's nothing to compare to." },
  ...
  },
  {
    ...
    category: "faq",
    title: "The weekly reflection isn't showing",
    summary: "It only appears on Sundays, and only if reflections are enabled.",
    keywords: ["weekly reflection missing", "reflection not showing", "sunday"],
    body: [
      { type: "p", text: "The reflection prompt is Sunday-only in the athlete app, and needs **Settings → Weekly Reflection → Enable weekly reflections** on with at least one score metric and the prompts filled in." },
    ],
  },
  {
