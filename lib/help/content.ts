...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      { type: "p", text: "At the bottom of each Strength exercise card (in the session builder, in Live group, and on the athlete's own **Session summary**) you'll see the previous session's sets, plus **▲ / ▼ / ＝ Best** and **▲ / ▼ / ＝ Load** — how the best set and the total tonnage moved." },
