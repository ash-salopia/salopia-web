...
// The Feature Requests room inside the Coach Forum. This is the board
// that used to live at /requests — moved here verbatim (composer,
// Top/New sort, upvote, expandable comments, admin status pipeline).
// Still backed by the feature_requests tables (0068/0069) and
// lib/data/feature-requests.ts, unchanged.
...
export default function FeatureRequestsRoom() {
  ...
  return (
    <div>
      <div style={styles.headerRow}>
        <p style={styles.subtitle}>Suggest an improvement to VIS BUILD, or upvote what matters to you. Shared across every coach on the platform.</p>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  subtitle: { fontSize: 13, color: "var(--mute)", margin: 0, maxWidth: 480 },
  ...
  cardDesc: { fontSize: 13, color: "var(--mute)", lineHeight: 1.5, margin: "6px 0 0", whiteSpace: "pre-wrap" as const },
  cardMeta: { display: "flex", alignItems: "center", gap: 14, marginTop: 10, fontSize: 12, color: "var(--mute)", flexWrap: "wrap" as const },
  ...
  commentBody: { color: "var(--mute)", flex: 1, whiteSpace: "pre-wrap" as const },
