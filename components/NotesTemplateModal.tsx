    ...
    <>
      ...
      <div style={s.overlay}>
        <div style={s.modal} onClick={(e) => e.stopPropagation()}>
          ...
          {phase === "input" && (
            <>
              <p style={s.hint}>Paste a training plan or upload an Excel file or a PDF (e.g. a printed or scanned session sheet). Claude will detect sessions and structure them into a reusable template.</p>
